-- ═══════════════════════════════════════════════════════════════════════════════
-- 🔧 RECREAR sp_Report_StockAlerts CON LA DEFINICIÓN CORRECTA
-- Solución al problema de campos ProductoNombre y Categoria vacíos
-- ═══════════════════════════════════════════════════════════════════════════════

PRINT '🔧 RECREANDO sp_Report_StockAlerts...';
PRINT '';
...
PRINT '';
PRINT '✅ sp_Report_StockAlerts RECREADO EXITOSAMENTE';
...
PRINT '';
PRINT '🎉 CORRECCIÓN COMPLETADA - Los campos ProductoNombre y Categoria ahora deberían funcionar correctamente';