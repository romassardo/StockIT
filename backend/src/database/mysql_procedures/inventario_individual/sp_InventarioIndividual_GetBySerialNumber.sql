-- =============================================
-- Description: Obtiene la información detallada de un ítem del inventario individual por su número de serie.
-- =============================================
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM InventarioIndividual WHERE numero_serie = p_numero_serie) THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'No se encontró ningún ítem con ese número de serie';
    END IF;
    ...
    WHERE 
        ii.numero_serie = p_numero_serie;
