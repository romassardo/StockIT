...
CREATE PROCEDURE dbo.sp_Report_StockAlerts
    @CategoriaID INT = NULL,           -- ID de categorÃ­a, NULL para todas
...
BEGIN
    ...
    BEGIN
        ...
        SELECT 
            ...
            0 AS DiasParaAgotarse, -- 0 dÃ­as porque ya estÃ¡ agotado
            (
                SELECT 
        ...
        WHERE 
            ...
            AND p.usa_numero_serie = 0 -- Solo productos sin nÃºmero de serie
    ...
    BEGIN
        ...
        WHERE 
            sg.cantidad_actual > 0 -- Excluir los que ya estÃ¡n sin stock
    ...
    -- Calcular estadÃ­sticas agregadas antes de la paginaciÃ³n
    ...
    -- Devolver estadÃ­sticas agregadas como segundo recordset
    SELECT 
