-- ═══════════════════════════════════════════════════════════════════════════════
-- 🔧 CORREGIR sp_Report_AssignmentsByDestination - VERSIÓN SIMPLIFICADA
-- ═══════════════════════════════════════════════════════════════════════════════

PRINT '🔧 CORRIGIENDO sp_Report_AssignmentsByDestination...';
PRINT '';

-- Eliminar SP problemático
...
PRINT '✅ sp_Report_AssignmentsByDestination CORREGIDO EXITOSAMENTE';
PRINT '';
